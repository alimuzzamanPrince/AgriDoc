...
?>
    ...
    <head>
      ...
      <body style="background-color: #512903">

        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container" style="background-color: #2d1804">
        ...
        <div class="container" style="margin-top:150px;font-family:Verdana, Geneva, sans-serif;font-size:15px;">
            <h1 style="color:#9e544d;text-align:center;">Message User</h1>

            <br>
            <br>
            <form class="form-signin" method="post" action="adminupload.php" enctype='multipart/form-data' name="amessage" style="background-color: #382104">
                ...
                <div class="form-group">
                    ...
                    Solution:
                    <textarea class="form-control" type="textarea" name="message" placeholder="Write your message" style="height:120px;"></textarea>
