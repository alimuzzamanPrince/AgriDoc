...
<!DOCTYPE html>
   ...
   <!--    <?php
    ...
    <?php
        ...
        $insert = $db->query("INSERT into adminsolution (usrid,message) VALUES ('$userid','$message')");
        if($insert && $userid!=''&& $message!=''){
            echo "<h1 style='color:#d87c08;text-align:center;'>Message sent successfully.</h1><br><p style='color:#d87c08;text-align:center;'><a href=\"adminmsg.php\">  Send Another Message </a></p><br><p style='color:#d87c08;text-align:center;'><a href=\"../index.html\">  Home </a></p>";
        }
        
        else{
            echo "<h2 style='color:#d87c08;text-align:center;' style='color:#d87c08;text-align:center'>You Forgot to Insert Something! Please <a href=\"adminmsg.php\">  Try Again </a></h2>";
        }
