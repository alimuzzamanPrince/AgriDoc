...
?>
    ...
    <body style="background-color: #42040f">
        ...
        <div class="signin-form">
            ...
            <div class="container">
                ...
                <form class="form-signin" method="post" id="login-form" style="background-color: #024056">

                    <h2 class="form-signin-heading" style="font-family: veranda">Sign In</h2>
                    <hr />
		...
		?>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <a href="../admin/index.php" class="btn btn-default" style="float:left;"><span class="glyphicon glyphicon-user"></span> &nbsp; Sign In as Admin</a>
